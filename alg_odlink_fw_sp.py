...
def alg_odlink_fw_sp(network_name, bool_display=True, bool_display_iteration=True):
    ...
    if bool_display:
        print('----alg_odlink_fw_sp----')
        print(f'current_odlink_flow:{current_odlink_flow}')
        print(f'optimal_value:{optimal_value}')
        print('--------')


if __name__ == '__main__':
    alg_odlink_fw_sp('simple_network')
